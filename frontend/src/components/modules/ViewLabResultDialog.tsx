/**
 * View Lab Result Dialog Component
 * Modal for viewing lab result details
 */
...
export function ViewLabResultDialog({ order, patient, onClose, onDownload }: ViewLabResultDialogProps) {
  useEffect(() => {
                ...
                <Card>
                  ...
                  <CardContent className="pt-6">
                    <div className="p-4 bg-green-50 rounded-lg">
                      <p className="text-sm text-gray-600 mb-2">Result Value:</p>
