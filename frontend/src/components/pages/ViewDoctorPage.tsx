...
import { ArrowLeft, Edit, Phone, Mail, Clock, Users, Star, Calendar, GraduationCap } from 'lucide-react';
import { api, Doctor } from '../../services/api';

interface ViewDoctorPageProps {
  doctorId: string;
  onBack: () => void;
  onEdit?: (doctorId: string) => void;
}

export function ViewDoctorPage({ doctorId, onBack, onEdit }: ViewDoctorPageProps) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        {onEdit && (
          <Button onClick={() => onEdit(doctorId)} className="bg-blue-600 hover:bg-blue-700">
