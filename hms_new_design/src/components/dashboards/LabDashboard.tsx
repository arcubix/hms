...
const navigationItems: NavigationItem[] = [
  ...
  { icon: <Microscope className="w-5 h-5" />, label: 'Laboratory System', id: 'lab-system' },
      ...
      default:
        return (
          <div className="p-6 space-y-6">
            {/* Quick Access to Full Lab System */}
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-1">Advanced Laboratory Management System</h3>
                      <p className="text-sm text-gray-600">Complete test management, sample tracking, quality control & AI-powered analytics</p>
                    </div>
                  </div>
                  <Button 
                    onClick={() => setActiveSection('lab-system')}
